...
public:
    ...
    void setupUi(QWidget *AudioPlayer)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/MyAudioPlayer/data/icon/AudioPlayer.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_positionLabel->setStyleSheet(QString::fromUtf8("color:rgb(97, 97, 97);"));
        ...
        m_infoLabel->setStyleSheet(QString::fromUtf8("color:rgb(120, 120, 120);"));
        ...
        m_songListWidget->setObjectName(QString::fromUtf8("m_songListWidget"));
        ...
        m_previousButton->setStyleSheet(QString::fromUtf8("background-color:rgba(255, 255, 255, 0);"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/MyAudioPlayer/data/icon/previous.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_playButton->setStyleSheet(QString::fromUtf8("background-color:rgba(255, 255, 255, 0);"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/MyAudioPlayer/data/icon/play.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_nextButton->setStyleSheet(QString::fromUtf8("background-color:rgba(255, 255, 255, 0);"));
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/MyAudioPlayer/data/icon/next.png"), QSize(), QIcon::Normal, QIcon::Off);
        m_nextButton->setIcon(icon3);
        m_nextButton->setIconSize(QSize(25, 25));
        m_lyricButton = new QPushButton(AudioPlayer);
        m_lyricButton->setObjectName(QString::fromUtf8("m_lyricButton"));
        m_lyricButton->setGeometry(QRect(602, 481, 21, 21));
        QFont font1;
        font1.setPointSize(12);
        m_lyricButton->setFont(font1);
        m_lyricButton->setStyleSheet(QString::fromUtf8("QPushButton#m_lyricButton:!hover{ background-color:rgba(255, 255, 255, 0); color:rgb(97, 97, 97); }QPushButton#m_lyricButton:hover{ background-color:rgba(255, 255, 255, 0); color:rgb(150, 150, 150); }"));
        m_playOrderButton = new QPushButton(AudioPlayer);
        m_playOrderButton->setObjectName(QString::fromUtf8("m_playOrderButton"));
        m_playOrderButton->setGeometry(QRect(622, 486, 25, 25));
        m_playOrderButton->setStyleSheet(QString::fromUtf8("background-color:rgba(255, 255, 255, 0);"));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/MyAudioPlayer/data/icon/shuffle.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_volumeButton->setStyleSheet(QString::fromUtf8("background-color:rgba(255, 255, 255, 0);"));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/MyAudioPlayer/data/icon/volume.png"), QSize(), QIcon::Normal, QIcon::Off);
        m_volumeButton->setIcon(icon5);
        m_volumeButton->setIconSize(QSize(24, 24));
        m_searchLineEdit = new QLineEdit(AudioPlayer);
        m_searchLineEdit->setObjectName(QString::fromUtf8("m_searchLineEdit"));
        ...
        m_networkSearchButton->setObjectName(QString::fromUtf8("m_networkSearchButton"));
        m_networkSearchButton->setGeometry(QRect(130, 15, 16, 16));
        m_networkSearchButton->setStyleSheet(QString::fromUtf8("background-color:rgba(255, 255, 255, 0);"));
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/MyAudioPlayer/data/icon/search.png"), QSize(), QIcon::Normal, QIcon::Off);
        m_networkSearchButton->setIcon(icon6);
        m_localSongButton = new QPushButton(AudioPlayer);
        m_localSongButton->setObjectName(QString::fromUtf8("m_localSongButton"));
        m_localSongButton->setGeometry(QRect(7, 4, 25, 25));
        m_localSongButton->setStyleSheet(QString::fromUtf8("background-color:rgba(255, 255, 255, 0);"));
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/MyAudioPlayer/data/icon/localSong.png"), QSize(), QIcon::Normal, QIcon::Off);
        m_localSongButton->setIcon(icon7);
        m_localSongButton->setIconSize(QSize(25, 25));
        m_networkSearchEdit = new QLineEdit(AudioPlayer);
        m_networkSearchEdit->setObjectName(QString::fromUtf8("m_networkSearchEdit"));
        ...
        m_networkSearchBackButton->setObjectName(QString::fromUtf8("m_networkSearchBackButton"));
        m_networkSearchBackButton->setGeometry(QRect(96, 10, 31, 23));
        m_networkSearchBackButton->setStyleSheet(QString::fromUtf8("QPushButton#m_networkSearchBackButton:!hover{ background-color:rgba(255, 255, 255, 0); color:rgb(97, 97, 97); }QPushButton#m_networkSearchBackButton:hover{ background-color:rgba(255, 255, 255, 0); color:rgb(150, 150, 150); }"));
        m_searchBackButton = new QPushButton(AudioPlayer);
        m_searchBackButton->setObjectName(QString::fromUtf8("m_searchBackButton"));
        m_searchBackButton->setGeometry(QRect(98, 40, 31, 23));
        m_searchBackButton->setFont(font);
        m_searchBackButton->setStyleSheet(QString::fromUtf8("QPushButton#m_searchBackButton:!hover{ background-color:rgba(255, 255, 255, 0); color:rgb(97, 97, 97); }QPushButton#m_searchBackButton:hover{ background-color:rgba(255, 255, 255, 0); color:rgb(150, 150, 150); }"));
        m_searchNextButton = new QPushButton(AudioPlayer);
        m_searchNextButton->setObjectName(QString::fromUtf8("m_searchNextButton"));
        m_searchNextButton->setGeometry(QRect(134, 40, 31, 23));
        m_searchNextButton->setFont(font);
        m_searchNextButton->setStyleSheet(QString::fromUtf8("QPushButton#m_searchNextButton:!hover{ background-color:rgba(255, 255, 255, 0); color:rgb(97, 97, 97); }QPushButton#m_searchNextButton:hover{ background-color:rgba(255, 255, 255, 0); color:rgb(150, 150, 150); }"));
        m_searchSrcBox = new QComboBox(AudioPlayer);
        m_searchSrcBox->setObjectName(QString::fromUtf8("m_searchSrcBox"));
        m_searchSrcBox->setGeometry(QRect(290, 12, 61, 22));
        m_songlistListWidget = new QListWidget(AudioPlayer);
        m_songlistListWidget->setObjectName(QString::fromUtf8("m_songlistListWidget"));
        ...
        m_addSonglistButton->setObjectName(QString::fromUtf8("m_addSonglistButton"));
        m_addSonglistButton->setGeometry(QRect(60, 68, 21, 23));
        QFont font2;
        font2.setPointSize(17);
        m_addSonglistButton->setFont(font2);
        m_addSonglistButton->setStyleSheet(QString::fromUtf8("QPushButton#m_addSonglistButton:!hover{ background-color:rgba(255, 255, 255, 0); color:rgb(97, 97, 97); }QPushButton#m_addSonglistButton:hover{ background-color:rgba(255, 255, 255, 0); color:rgb(150, 150, 150); }"));
        m_songlistButton = new QPushButton(AudioPlayer);
        m_songlistButton->setObjectName(QString::fromUtf8("m_songlistButton"));
        m_songlistButton->setGeometry(QRect(4, 68, 61, 23));
        m_songlistButton->setStyleSheet(QString::fromUtf8("QPushButton#m_songlistButton:!hover{ background-color:rgba(255, 255, 255, 0); color:rgb(97, 97, 97); }\n"
"QPushButton#m_songlistButton:hover{ background-color:rgba(255, 255, 255, 0); color:rgb(150, 150, 150); }"));
        ...
        m_currentSonglistLabel->setObjectName(QString::fromUtf8("m_currentSonglistLabel"));
        m_currentSonglistLabel->setGeometry(QRect(290, 50, 131, 16));
        m_currentSonglistLabel->setFont(font);
        m_currentSonglistLabel->setStyleSheet(QString::fromUtf8("color:rgb(200, 200, 200);"));
        m_currentSonglistLabel->setAlignment(Qt::AlignCenter);
        m_lyricTranslatedButton = new QPushButton(AudioPlayer);
        m_lyricTranslatedButton->setObjectName(QString::fromUtf8("m_lyricTranslatedButton"));
        m_lyricTranslatedButton->setGeometry(QRect(602, 499, 21, 21));
        m_lyricTranslatedButton->setFont(font1);
        m_lyricTranslatedButton->setStyleSheet(QString::fromUtf8("QPushButton#m_lyricTranslatedButton:!hover{ background-color:rgba(255, 255, 255, 0); color:rgb(97, 97, 97); }QPushButton#m_lyricTranslatedButton:hover{ background-color:rgba(255, 255, 255, 0); color:rgb(150, 150, 150); }"));
